...
if a negative argument is passed as initialAge, the constructor should set age to 0 and print
...
and is trimmed before being compared against the test case's expected output.
