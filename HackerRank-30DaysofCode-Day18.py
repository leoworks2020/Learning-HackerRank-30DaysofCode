...
4. A char popCharacter() method that pops
and returns the character at the top of the stack instance variable.
5. A char dequeueCharacter() method that dequeues
and returns the first character in the queue instance variable.
...
----------------------------------------------------------------------------------------------------------
Challenge Start Date =  2023-07-31
Challenge End Date   =  2023-07-31
"""
import sys
...
class Solution:
    ...
    def popCharacter(self):
        pop_char = self.stack.pop(-1)
        return pop_char

    def dequeueCharacter(self):
        dequeue_char = self.queue.pop(0)
        return dequeue_char
