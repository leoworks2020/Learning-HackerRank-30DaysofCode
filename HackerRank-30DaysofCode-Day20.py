...
and we print the necessary 3 lines of output shown above.
...
Explanation 1
The array  is not sorted, so we perform the following 3 swaps.
...
----------------------------------------------------------------------------------------------------------
Challenge Start Date =  2023-08-02
Challenge End Date   =  2023-08-02
"""
#!/bin/python3
...
def buble_sort(arr):
    ...
    #1st for used to iterate on number of items
    for n in range(len(arr)):
        #2nd for to do a swap in all items in the list
