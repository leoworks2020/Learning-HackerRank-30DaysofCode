...
def bitwiseAnd(N, K):
    ...
    second_number = 0
    while first_number < N and attempt < K:
        for second_number in range(first_number+1,len(numbers)+1):
            ...
            #if bitwise_AB_int >= bitwise_AB_values_position and bitwise_AB_int < K:
            #    bitwise_AB_values_position = bitwise_AB_int
    ...
    for i in range(0,K):
        #if bitwise_AB_values_position == K-1:
        #    break
...
if __name__ == '__main__':
    ...
    for t_itr in range(t):
        ...
        if DBG == 1: print(f'bitwise_max_value = {res}')
